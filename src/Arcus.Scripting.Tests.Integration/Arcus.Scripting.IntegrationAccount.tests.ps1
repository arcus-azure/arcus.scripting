...
function global:Retry-Function-IntegrationAccount ($func, $retryCount = 10, $retryIntervalSeconds = 1) {
    $attempt = 0
    $success = $false
    $result = $null
    do {
    ...
    Describe "Arcus Azure Integration Account integration tests" {
        ...
        Context "Uploading Schemas into an Azure Integration Account" {
            ...
            It "Create a single schema in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountSchemas -ResourceGroupName $resourceGroupName -Name $integrationAccountName -SchemaFilePath $schema.FullName -ErrorAction Stop }

                    # Assert
                    $actual = Retry-Function-IntegrationAccount { Get-AzIntegrationAccountSchema -ResourceGroupName $resourceGroupName -Name $integrationAccountName -SchemaName $expectedSchemaName -ErrorAction Stop }
                    ...
                    Retry-Function-IntegrationAccount { Remove-AzIntegrationAccountSchema -ResourceGroupName $resourceGroupName -Name $integrationAccountName -SchemaName $expectedSchemaName -Force -ErrorAction Stop }
                }
            }
            It "Update a single schema in an Integration Account succeeds" {
                ...
                $existingSchema = Retry-Function-IntegrationAccount { New-AzIntegrationAccountSchema -ResourceGroupName $resourceGroupName -Name $integrationAccountName -SchemaName $expectedSchemaName -SchemaFilePath $schema.FullName -ErrorAction Stop }
            ...
            It "Create a single schema, without extension, in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountSchemas -ResourceGroupName $resourceGroupName -Name $integrationAccountName -SchemaFilePath $schema.FullName -RemoveFileExtensions -ErrorAction Stop }
            ...
            It "Create a single schema, without extension and with prefix, in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountSchemas -ResourceGroupName $resourceGroupName -Name $integrationAccountName -SchemaFilePath $schema.FullName -ArtifactsPrefix $artifactsPrefix -RemoveFileExtensions -ErrorAction Stop }
            ...
            It "Create multiple schemas located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountSchemas -ResourceGroupName $resourceGroupName -Name $integrationAccountName -SchemasFolder $schemasFolder -ErrorAction Stop }
            ...
            It "Create multiple schemas, without extension, located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountSchemas -ResourceGroupName $resourceGroupName -Name $integrationAccountName -SchemasFolder $schemasFolder -RemoveFileExtensions -ErrorAction Stop }
            ...
            It "Create multiple schemas, without extension and with prefix, located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountSchemas -ResourceGroupName $resourceGroupName -Name $integrationAccountName -SchemasFolder $schemasFolder -ArtifactsPrefix $artifactsPrefix -RemoveFileExtensions -ErrorAction Stop }
        ...
        Context "Uploading Maps into an Azure Integration Account" {
            ...
            It "Create a single map in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountMaps -ResourceGroupName $resourceGroupName -Name $integrationAccountName -MapFilePath $map.FullName -ErrorAction Stop }

                    # Assert
                    $actual = Retry-Function-IntegrationAccount { Get-AzIntegrationAccountMap -ResourceGroupName $resourceGroupName -Name $integrationAccountName -MapName $expectedMapName -ErrorAction Stop }
                    $actual | Should -Not -BeNullOrEmpty 
                    $actual.CreatedTime.ToUniversalTime().ToString("yyyy-MM-dd") | Should -Be $actual.ChangedTime.ToUniversalTime().ToString("yyyy-MM-dd")
                    $actual.CreatedTime | Should -BeGreaterOrEqual $executionDateTime

                } finally {
                    Retry-Function-IntegrationAccount { Remove-AzIntegrationAccountMap -ResourceGroupName $resourceGroupName -Name $integrationAccountName -MapName $expectedMapName -Force -ErrorAction Stop }
                }
            }
            It "Update a single map in an Integration Account succeeds" {
                ...
                $existingMap = Retry-Function-IntegrationAccount { New-AzIntegrationAccountMap -ResourceGroupName $resourceGroupName -Name $integrationAccountName -MapName $expectedMapName -MapFilePath $map.FullName -ErrorAction Stop }
            ...
            It "Create a single map, without extension, in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountMaps -ResourceGroupName $resourceGroupName -Name $integrationAccountName -MapFilePath $map.FullName -RemoveFileExtensions -ErrorAction Stop }
            ...
            It "Create a single map, without extension and with prefix, in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountMaps -ResourceGroupName $resourceGroupName -Name $integrationAccountName -MapFilePath $map.FullName -ArtifactsPrefix $artifactsPrefix -RemoveFileExtensions -ErrorAction Stop }
            ...
            It "Create multiple maps located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountMaps -ResourceGroupName $resourceGroupName -Name $integrationAccountName -MapsFolder $mapsFolder -ErrorAction Stop }
            ...
            It "Create multiple maps, without extension, located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountMaps -ResourceGroupName $resourceGroupName -Name $integrationAccountName -MapsFolder $mapsFolder -RemoveFileExtensions -ErrorAction Stop }
            ...
            It "Create multiple maps, without extension and with prefix, located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountMaps -ResourceGroupName $resourceGroupName -Name $integrationAccountName -MapsFolder $mapsFolder -ArtifactsPrefix $artifactsPrefix -RemoveFileExtensions -ErrorAction Stop }
        ...
        Context "Uploading Assemblies into an Azure Integration Account" {
            ...
            It "Create a single assembly in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountAssemblies -ResourceGroupName $resourceGroupName -Name $integrationAccountName -AssemblyFilePath $assembly.FullName -ErrorAction Stop }

                    # Assert
                    $actual = Retry-Function-IntegrationAccount { Get-AzIntegrationAccountAssembly -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -AssemblyName $expectedAssemblyName -ErrorAction Stop }
                    $actual | Should -Not -BeNullOrEmpty 
                    ...
                    Retry-Function-IntegrationAccount { Remove-AzIntegrationAccountAssembly -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -AssemblyName $expectedAssemblyName -ErrorAction Stop }
                }
            }
            ...
            It "Create a single assembly, with prefix, in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountAssemblies -ResourceGroupName $resourceGroupName -Name $integrationAccountName -AssemblyFilePath $assembly.FullName -ArtifactsPrefix $artifactsPrefix -ErrorAction Stop }
            ...
            It "Create multiple assemblies located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountAssemblies -ResourceGroupName $resourceGroupName -Name $integrationAccountName -AssembliesFolder $assembliesFolder -ErrorAction Stop }
            ...
            It "Create multiple assemblies, with prefix, located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountAssemblies -ResourceGroupName $resourceGroupName -Name $integrationAccountName -AssembliesFolder $assembliesFolder -ArtifactsPrefix $artifactsPrefix -ErrorAction Stop }
        ...
        Context "Uploading Certificates into an Azure Integration Account" {
            ...
            It "Create a single public certificate in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountCertificates -ResourceGroupName $resourceGroupName -Name $integrationAccountName -CertificateType 'Public' -CertificateFilePath $certificate.FullName -ErrorAction Stop }

                    # Assert
                    $actual = Retry-Function-IntegrationAccount { Get-AzIntegrationAccountCertificate -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -CertificateName $expectedCertificateName -ErrorAction Stop }
                    $actual | Should -Not -BeNullOrEmpty 
                    $actual.CreatedTime.ToUniversalTime().ToString("yyyy-MM-dd") | Should -Be $actual.ChangedTime.ToUniversalTime().ToString("yyyy-MM-dd")
                    $actual.CreatedTime | Should -BeGreaterOrEqual $executionDateTime
            ...
            It "Create a single public certificate, with prefix, in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountCertificates -ResourceGroupName $resourceGroupName -Name $integrationAccountName -CertificateType 'Public' -CertificateFilePath $certificate.FullName -ArtifactsPrefix $artifactsPrefix -ErrorAction Stop }
            ...
            It "Create multiple public certificates located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountCertificates -ResourceGroupName $resourceGroupName -Name $integrationAccountName -CertificateType 'Public' -CertificatesFolder $certificatesFolder -ErrorAction Stop }
            ...
            It "Create multiple public certificates, with prefix, located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountCertificates -ResourceGroupName $resourceGroupName -Name $integrationAccountName -CertificateType 'Public' -CertificatesFolder $certificatesFolder -ArtifactsPrefix $artifactsPrefix -ErrorAction Stop }
            ...
            It "Create a single private certificate in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountCertificates -ResourceGroupName $resourceGroupName -Name $integrationAccountName -CertificateType 'Private' -CertificateFilePath $certificate.FullName -KeyName $key.Name -KeyVersion $key.Version -KeyVaultId $keyVaultId -ErrorAction Stop }
                    ...
                    Retry-Function-IntegrationAccount { Remove-AzIntegrationAccountCertificate -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -CertificateName $expectedCertificateName -Force -ErrorAction Stop }
                    Retry-Function-IntegrationAccount { Remove-AzKeyVaultKey -VaultName $config.Arcus.KeyVault.VaultName -Name $keyName -Force -ErrorAction Stop }
                }
            }
            It "Create a single private certificate, with prefix, in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountCertificates -ResourceGroupName $resourceGroupName -Name $integrationAccountName -CertificateType 'Private' -CertificateFilePath $certificate.FullName -ArtifactsPrefix $artifactsPrefix -KeyName $key.Name -KeyVersion $key.Version -KeyVaultId $keyVaultId -ErrorAction Stop }
        ...
        Context "Uploading Partners into an Azure Integration Account" {
            ...
            It "Create a single partner in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountPartners -ResourceGroupName $resourceGroupName -Name $integrationAccountName -PartnerFilePath $partner.FullName -ErrorAction Stop }

                    # Assert
                    $actual = Retry-Function-IntegrationAccount { Get-AzIntegrationAccountPartner -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -PartnerName $expectedPartnerName -ErrorAction Stop }
                    $actual | Should -Not -BeNullOrEmpty 
                    $actual.CreatedTime.ToUniversalTime().ToString("yyyy-MM-dd") | Should -Be $actual.ChangedTime.ToUniversalTime().ToString("yyyy-MM-dd")
                    $actual.CreatedTime | Should -BeGreaterOrEqual $executionDateTime
            ...
            It "Create a single partner, with prefix, in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountPartners -ResourceGroupName $resourceGroupName -Name $integrationAccountName -PartnerFilePath $partner.FullName -ArtifactsPrefix $artifactsPrefix -ErrorAction Stop }
            ...
            It "Create multiple partners located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountPartners -ResourceGroupName $resourceGroupName -Name $integrationAccountName -PartnersFolder $partnersFolder -ErrorAction Stop }
            ...
            It "Create multiple partners, with prefix, located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountPartners -ResourceGroupName $resourceGroupName -Name $integrationAccountName -PartnersFolder $partnersFolder -ArtifactsPrefix $artifactsPrefix -ErrorAction Stop }
        ...
        Context "Uploading Agreements into an Azure Integration Account" {
            ...
            It "Create a single agreement in an Integration Account succeeds" {
                ...
                Retry-Function-IntegrationAccount { New-AzIntegrationAccountPartner -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -PartnerName Partner1 -BusinessIdentities @("1", "12345") -ErrorAction Stop }
                Retry-Function-IntegrationAccount { New-AzIntegrationAccountPartner -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -PartnerName Partner2 -BusinessIdentities @("1", "98765") -ErrorAction Stop }

                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountAgreements -ResourceGroupName $resourceGroupName -Name $integrationAccountName -AgreementFilePath $agreement.FullName -ErrorAction Stop }
                    ...
                    Retry-Function-IntegrationAccount { Remove-AzIntegrationAccountAgreement -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -AgreementName $expectedAgreementName -Force -ErrorAction Stop }
                    Retry-Function-IntegrationAccount { Remove-AzIntegrationAccountPartner -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -PartnerName Partner1 -Force -ErrorAction Stop }
                    Retry-Function-IntegrationAccount { Remove-AzIntegrationAccountPartner -ResourceGroupName $resourceGroupName -IntegrationAccountName $integrationAccountName -PartnerName Partner2 -Force -ErrorAction Stop }
                }
            }
            ...
            It "Create multiple agreements located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountAgreements -ResourceGroupName $resourceGroupName -Name $integrationAccountName -AgreementsFolder $agreementsFolder -ErrorAction Stop }
            ...
            It "Create multiple agreements, with prefix, located in a folder in an Integration Account succeeds" {
                ...
                try {
                    # Act
                    Retry-Function-IntegrationAccount { Set-AzIntegrationAccountAgreements -ResourceGroupName $resourceGroupName -Name $integrationAccountName -AgreementsFolder $agreementsFolder -ArtifactsPrefix $artifactsPrefix -ErrorAction Stop }
