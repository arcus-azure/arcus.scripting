    ...
    Describe "Arcus Azure Logic Apps Consumption unit tests" {
        ...
        Context "Enable Logic Apps with configuration" {
            It "Doesn't enable anything when the stopType is not recognized" {
                ...
                # Act
                Enable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-unknownStopType.json" -ResourceGroupName "ignored-resource-group"
            ...
            It "Doesn't enable anything when both checkType & stopType is 'None'" {
                ...
                # Act
                Enable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-none.json" -ResourceGroupName "ignored-resource-group"
        ...
        Context "Disable Logic Apps with configuration" {
            It "Doesn't disable anything when the checkType is not recognized" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-unknownCheckType.json" -ResourceGroup "ignored-resource-group"
            ...
            It "Doesn't disable anything when the stopType is not recognized" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-unknownStopType.json" -ResourceGroupName "ignored-resource-group"
            ...
            It "Doesn't disable anything when both checkType & stopType is 'None'" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-none.json" -ResourceGroupName "ignored-resource-group"
            ...
            It "Doesn't disable anything when checkType = NoWaitingOrRunningRuns but returns a zero count on the running runs for unknown stopType" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-noWaitingOrRunningRunsWithunknownStopType.json" -ResourceGroupName $resourceGroup
            ...
            It "Doesn't disable anything when checkType = NoWaitingOrRunningRuns but returns a zero count on an the waiting runs for stopType = None" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-noWaitingOrRunningRunsWithNoneStopType.json" -ResourceGroupName $resourceGroup
            ...
            It "Disables all logic apps when checkType = NoWaitingOrRunningRuns with found waiting and no running runs for stopType = Immediate" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-noWaitingOrRunningRunsWithImmediate.json" -ResourceGroupName $resourceGroup
            ...
            It "Disables all logic apps when checkType = NoWaitingOrRunningRuns with found waiting and running runs for stopType = Immediate" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-noWaitingOrRunningRunsWithSingleImmediate.json" -ResourceGroupName $resourceGroup
            ...
            It "Disables all logic apps with option maximumFollowNextPageLink set to 25" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-maximumFollowNextPageLink.json" -ResourceGroupName $resourceGroup
            ...
            It "Disables all logic apps with option maximumFollowNextPageLink defaults to 10" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Consumption\deploy-orderControl-noMaximumFollowNextPageLink.json" -ResourceGroupName $resourceGroup
    ...
    Describe "Arcus Azure Logic Apps Standard unit tests" {
        ...
        Context "Enable Logic Apps with configuration" {
            It "Doesn't enable anything when the stopType is not recognized" {
                ...
                # Act
                Enable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Standard\deploy-orderControl-unknownStopType.json" -ResourceGroupName "ignored-resource-group"
            ...
            It "Doesn't enable anything when both checkType & stopType is 'None'" {
                ...
                # Act
                Enable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Standard\deploy-orderControl-none.json" -ResourceGroupName "ignored-resource-group"
        ...
        Context "Disable Logic Apps with configuration" {
            It "Doesn't disable anything when the checkType is not recognized" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Standard\deploy-orderControl-unknownCheckType.json" -ResourceGroup "ignored-resource-group"
            ...
            It "Doesn't disable anything when the stopType is not recognized" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Standard\deploy-orderControl-unknownStopType.json" -ResourceGroupName "ignored-resource-group"
            ...
            It "Doesn't disable anything when both checkType & stopType is 'None'" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Standard\deploy-orderControl-none.json" -ResourceGroupName "ignored-resource-group"
            ...
            It "Doesn't disable anything when checkType = NoWaitingOrRunningRuns but returns a running run for unknown stopType" {
                # Arrange
                $script:i = 0
                $resourceGroup = "my-resource-group"
                $logicAppNames = @("snd-async", "ord-sthp-harvest-order-doublechecker", "ord-sthp-harvest-order-doublechecker")
                ...
                Mock Invoke-WebRequest -MockWith {
                    ...
                    if ($script:i -gt 2) {
                        ...
                        Write-Host "Returning 1 running run"
                        return [pscustomobject] @{
                            Content = '{"value":[{"properties":{"status":"Running"}}]}'
                        }
                    }
                }
                Mock Disable-AzLogicApp {}
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Standard\deploy-orderControl-noWaitingOrRunningRunsWithunknownStopType.json" -ResourceGroupName $resourceGroup
            ...
            It "Doesn't disable anything when checkType = NoWaitingOrRunningRuns but returns a waiting run for stopType = None" {
                ...
                Mock Invoke-WebRequest -MockWith {
                    ...
                    if ($script:i -gt 2) {
                        ...
                        Write-Host "Returning 1 waiting run"
                        return [pscustomobject] @{
                            Content = '{"value":[{"properties":{"status":"Waiting"}}]}'
                        }
                    }
                }
                Mock Disable-AzLogicApp {}
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Standard\deploy-orderControl-noWaitingOrRunningRunsWithNoneStopType.json" -ResourceGroupName $resourceGroup
            ...
            It "Disables all logic apps when checkType = NoWaitingOrRunningRuns with found waiting and no running runs for stopType = Immediate" {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Standard\deploy-orderControl-noWaitingOrRunningRunsWithImmediate.json" -ResourceGroupName $resourceGroup
            ...
            It "Disables all logic apps when checkType = NoWaitingOrRunningRuns with found waiting and running runs for stopType = Immediate" {
                ...
                Mock Invoke-WebRequest -MockWith {
                    ...
                    if ($script:i -gt 2) {
                        ...
                        return [pscustomobject] @{
                            Content = '{"value":[{"properties":{"status":"Waiting"}},{"properties":{"status":"Running"}}]}'
                        }
                    }
                }
                Mock Disable-AzLogicApp {
                ...
                # Act
                Disable-AzLogicAppsFromConfig -DeployFileName "$PSScriptRoot\Files\LogicApps\Standard\deploy-orderControl-noWaitingOrRunningRunsWithSingleImmediate.json" -ResourceGroupName $resourceGroup
