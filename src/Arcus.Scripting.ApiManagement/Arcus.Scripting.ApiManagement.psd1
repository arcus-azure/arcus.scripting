...
FunctionsToExport = @('Create-AzApiManagementApiOperation', 'Remove-AzApiManagementDefaults', 'Import-AzApiManagementApiPolicy', 'Import-AzApiManagementOperationPolicy')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure','ApiManagement', 'Arcus'
